...
import "../../../styles/mobile/loginPage/MbRegisterSection.scss";
function MbRegisterSection() {
  ...
  return (
    <div className="MbregisterSection-container">
      <div className="MbregisterSection-wrapper">
...
export default MbRegisterSection;
